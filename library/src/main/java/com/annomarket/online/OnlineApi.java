...
/**
 * Main entry point for the AnnoMarket online API to send individual
 * documents for annotation by a particular pipeline and receive the
 * results immediately.
 * 
 * @author Ian Roberts, Petar Kostov
 */
public class OnlineApi {
   ...
   * pipeline on the AnnoMarket.com platform using the given
   * credentials.
   * 
